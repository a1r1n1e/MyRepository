...
import whobuys.vovch.vovch.light.fragment.group_activity.GroupFragmentActive;
import whobuys.vovch.vovch.light.fragment.group_activity.GroupFragmentHistory;
...
public class Group2Activity extends WithLoginActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("android.resource://whobuys.vovch.light.vovch.vovch.whobuys.vovch.light/mipmap/settings_more");
            ...
            builder.setNegativeButton(button2String, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    activeActivityProvider.createListogramOffline(list.getItems(),
                            list.getStoreName(), list.getStoreTime());
                }
            });
