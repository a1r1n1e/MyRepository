...
import whobuys.vovch.vovch.light.data_types.GroupButton;
        ...
        if(getActivity() != null) {
            ...
            if (informer.getGroup().getState().equals(UserGroup.DEFAULT_GROUP_STATE_UNWATCHED)) {
                ...
                if (informer.isActive()) {
                    ...
                    Uri uri = Uri.parse("android.resource://whobuys.vovch.light.vovch.vovch.whobuys.vovch.light/mipmap/alarm_custom_green_white");
                ...
                if (informer.isActive()) {
                    ...
                    Uri uri = Uri.parse("android.resource://whobuys.vovch.light.vovch.vovch.whobuys.vovch.light/mipmap/small_alarm_green");
                    attentionButton.setImageURI(uri);
                    attentionButtonFrame.addView(attentionButton);
                }
            }
