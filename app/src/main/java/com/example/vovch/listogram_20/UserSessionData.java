...
public class UserSessionData {
    ...
    protected void setUserData(String newId, String newName, String newLogin, String newPassword){
        id = newId;
        name = newName;
        login = newLogin;
        password = newPassword;
    }
    protected void checkUserData(String newId, String newLogin, String newPassword){
    ...
    protected boolean isAnyPrefsData(){
    ...
    protected void savePrefs(final String userId, final String userName, final String userPassword){    // Should be used not from UI thread
        SharedPreferences.Editor editor = preferences.edit();
    ...
    protected void registerForPushes(){
