...
public class GroupSettingsActivity extends AppCompatActivity {
    ...
    protected void drawOldMembers(LinearLayout parentLayout){
    ...
    protected void drawNewMembers(LinearLayout parentLayout, AddingUser[] newMembers){
    ...
    protected void drawNewUserLayout(AddingUser user, boolean loadType, LinearLayout parentLayout){
    ...
    protected void confirmGood(UserGroup result){
        if(provider.getActiveActivityNumber() == 7) {
            provider.nullActiveActivity();
        }
        provider.clearNewGroupPossibleMembers();
    ...
    protected void confirmBad(UserGroup result){
        TextView erView = (TextView) findViewById(R.id.newgrouperrorreporter);
