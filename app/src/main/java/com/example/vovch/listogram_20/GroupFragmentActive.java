...
public class GroupFragmentActive extends Fragment {
    ...
    protected void fragmentShowSecondGood(SList result){
        CardView cardView = result.getCardView();
        cardView.setVisibility(View.GONE);
    }
    protected void fragmentShowSecondBad(SList result){                                                //TODO remember result is always null
        if(result != null){
    ...
    protected void fragmentShowThirdGood(Item item){
    ...
    protected void fragmentShowThirdBad(Item item){
        if(item != null) {
    ...
    protected void fragmentShowProcessing(Item item){
        LinearLayout layout = item.getLayout();
