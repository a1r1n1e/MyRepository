...
public class Group2Activity extends WithLoginActivity {
    ...
    protected void showSecondGood(String result){
        int markId = markedId - LISTOGRAM_BUTTON_BIG_NUMBER;
        if(result.equals("0")){
            Button itemMarkTouchedButton = (Button) findViewById(markedId);
    ...
    protected void showThirdGood(String result){
        int newId = disId - LISTOGRAM_DIS_BUTTON_BIG_NUMBER;
    ...
    protected class ItemMarkTask extends FirstLoginAttemptTask {
        ItemMarkTask(String userId, String itemIdAndGroupId,  String third, String action, int newId){
            super(userId, itemIdAndGroupId, third, action, "3", "1");
            markedId = newId;
        }
        /*@Override
        protected void onGoodResult(String result){
    ...
    protected class DisactivateListTask extends FirstLoginAttemptTask {
        DisactivateListTask(String groupId, String listId, int disButtonId){
            super(groupId, listId, "disactivatelist", "3", "2");
            disId = disButtonId;
