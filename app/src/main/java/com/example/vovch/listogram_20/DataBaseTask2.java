...
class DataBaseTask2 {
    ...
    protected DataBaseTask2(Context context){
        applicationContext = context;
        provider = (ActiveActivityProvider) applicationContext;
    }
    protected SList[] getOffline(int taskType){
        String typeTask;
        SList[] sLists = null;
        Item[] items;
    ...
    protected void disactivateOfflineList(String listId){                                           //REFACTOR FOR DATASTORAGE
        try {
            dbHelper = new DbHelper(applicationContext);
    ...
    protected void itemMarkOffline(String itemId){                                           //REFACTOR FOR DATASTORAGE
        try {
            dbHelper = new DbHelper(applicationContext);
            SQLiteDatabase db = dbHelper.getWritableDatabase();
    ...
    protected SList addList(Item[] incomingItems) {                                           //REFACTOR FOR DATASTORAGE
